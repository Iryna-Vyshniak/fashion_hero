...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = t(require('three'), require('gsap')))
    : 'function' == typeof define && define.amd
    ? define(['three', 'gsap'], t)
    : ((e || self).hoverEffect = t(e.THREE, e.gsap));
})(this, function (e, t) {
  function n(e) {
    ...
    if (n)
      if (a && s && i) {
        ...
        n.offsetHeight / n.offsetWidth < O
          ? ((H = 1), (E = n.offsetHeight / n.offsetWidth / O))
        ...
        var R = new r.ShaderMaterial({
            uniforms: {
              ...
              angle1: { type: 'f', value: c },
              angle2: { type: 'f', value: v },
              texture1: { type: 't', value: P },
              texture2: { type: 't', value: M },
              disp: { type: 't', value: W },
              res: { type: 'vec4', value: new r.Vector4(n.offsetWidth, n.offsetHeight, H, E) },
        ...
        F.add(_),
          ...
          window.addEventListener('resize', function (e) {
            n.offsetHeight / n.offsetWidth < O
              ? ((H = 1), (E = n.offsetHeight / n.offsetWidth / O))
              : ((H = (n.offsetWidth / n.offsetHeight) * O), (E = 1)),
              (_.material.uniforms.res.value = new r.Vector4(n.offsetWidth, n.offsetHeight, H, E)),
              w.setSize(n.offsetWidth, n.offsetHeight),
              L();
          }),
          (this.next = C),
...
//https://www.npmjs.com/package/hover-effect?activeTab=code
//https://www.npmjs.com/package/hover-effect?activeTab=readme
